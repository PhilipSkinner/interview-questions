//1-> Given an enumerable of strings, attempt to parse each string and if
...
//2-> Given two enumerables of strings, find the longest common word.
...
//3-> Write a function that converts kilometers to miles, given that there are
// 1.6 kilometers per mile.
const distanceInMiles = (kilometers) => {
	return parseFloat(kilometers/1.6)
};

//4-> Write a function that converts miles to kilometers, give that there are
const distanceInKm = (miles) => {
	return parseFloat(miles*(1.6))
};

//5-> Write a function that returns true if the word is a palindrome, false if
// it is not.
// For example:
// isPalindrome("Anna");
...
//6-> Write a function that takes an enumerable list of objects and shuffles
...
//7-> Write a function that sorts an array of integers into ascending
const sort = (source = []) => {
...
//9-> Generate a list of integers from 1 to 100.
//
